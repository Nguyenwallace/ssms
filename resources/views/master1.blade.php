    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="" ><b>Stock & Sales Management</b></a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="">Products Shared</a>
                                </li>
                                <li>
                                    <a href="">Revenue Report</a>
                                </li>
								<li>
                                    <a href="">Customer Shared</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
						<li>
                            <a href="#"><i class="fa fa-phone fa-fw"></i> Quotation<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="">Latest Quotation</a>
                                </li>
                                <li>
                                    <a href="">New customer quote</a>
                                </li>
								<li>
                                    <a href="">Quote today</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
						<li>
                            <a href="#"><i class="fa fa-female fa-fw"></i> Customer<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="">New customer</a>
                                </li>
                                <li>
                                    <a href="">Need payment follow</a>
                                </li>
								<li>
                                    <a href="">Order on progressing</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
						<li>
                            <a href="#"><i class="fa fa-male fa-fw"></i> Supplier<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="">All Detailed</a>
                                </li>
                                <li>
                                    <a href="">Need to payment</a>
                                </li>
								<li>
                                    <a href="">Shipment on progressing</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>                     
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="">Exported Products</a>
                                </li>                               
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
						<li>
                            <a href="#"><i class="fa fa-heart fa-fw"></i> Orders<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="">Management</a>
                                </li>
