<script>
			...
			{	
				...
				getTotalAmount();
				 $( "#product" ).autocomplete({					
				  source: "{{url('admin/autocomplete/quotation')}}",
				  width: 160,
				  autoFill: true,
				  selectFirst: false,
				  minLength: 3,
				...
				$( "#supName" ).autocomplete({		
				  source: "{{url('admin/autocomplete/supplier')}}",
				  width: 160,
				  autoFill: true,
				  selectFirst: false,
				  minLength: 1,
				...
				$("#product").blur(function () {
					...
					var url = "{{url('admin/blur/quotation')}}";
					$.ajax({						
						type: "post",
						url: url, 	
						cache: false,
				...
				$("#cusName").blur(function () {
					var _token = $("form[name='productForm']").find("input[name='_token']").val();
					var product= $(this).value;
					var url = "{{url('admin/blur/customer')}}";
					$.ajax({						
						type: "post",
						url: url, 	
						cache: false,
				...
				$("#supName").blur(function () {
					var _token = $("form[name='productForm']").find("input[name='_token']").val();
					//var product= $(this).value;
					var url = "{{url('admin/blur/supplier')}}";
					$.ajax({						
						type: "post",
						url: url, 	
						cache: false,
		...
		function quickAddCustomer(){
			...
			var url = "{{url('admin/ajax/cusquickadd')}}";
					$.ajax({						
							type: "post",
							url: url, 	
							cache: false,
		...
		function quickAddSupplier(){
			...
			var url = "{{url('admin/ajax/supquickadd')}}";
					$.ajax({						
							type: "post",
							url: url, 	
							cache: false,
