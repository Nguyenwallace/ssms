...
@section('headscript')
<script src="{{ asset('js/supplier1.js') }}"></script>
@endsection
@section('content')
 <div id="page-wrapper">
			<div id="topbar">
				<nav class="navbar navbar-default">
					  <div class="container-fluid">						
						<ul class="nav navbar-nav">
						  ...
						  <li><a href="#"><b>Nhà Cung Cấp VIP</b></a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <b> Bảng Liệt Kê Nhà Cung Cấp</b>						   
                        </div>
						<div class="row">
						<div class="container col-md-6">
						<form class="form-horizontal" method="post" action="{!! url('admin/supplier')!!}">
								...
								<input type="hidden" name="_token" value="{!! csrf_token() !!}">						
									<!--
									<div class="panel-heading">
										<label for="page" class="control-label">Nhà Cung Cấp /Trang</label>							
									...
									<div class="panel-heading container col-md-6 input-group custom-search-form pull-left">
										<input type="text" name= "perpage" class="form-control" placeholder="Nhà Cung Cấp/ Trang">
                                    ...
                                    <tr class="gradeU">
                                        ...
                                        <td class="column-verticallineMiddle form-inline"><div class="dropdown">
											...
											<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
											  ...
											  <li role="presentation"><a role="menuitem" tabindex="-1" href="{!! action('SupplierController@delete', $supplier->id) !!}" onclick="return confirm('Bạn chắc chắn muốn xóa?');">Xóa</a></li>
											  <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Chọn thêm</a></li>										  
											</ul>
										  </div></td>
										  <td><label class="checkbox-inline"><input type="checkbox" id="checkbox{{$supplier->id}}" value="">Chọn</label></td>
                                    </tr>
                                    @endforeach
                                </tbody>								
                            </table>
						...
						<fieldset>
							<legend>Tải lên/Tải xuống</legend>
								...
								<form class="form-horizontal" method="post" action="{!!url('admin/supplier/upload')!!}" enctype="multipart/form-data">
									<input type="hidden" name="_token" value="{!! csrf_token() !!}">
								...
								<form class="form-horizontal" method="post" action="{!!url('admin/supplier/download')!!}" enctype="multipart/form-data">
									<input type="hidden" name="_token" value="{!! csrf_token() !!}">												
										<div class="form-group">
											<div class="col-lg-10">				
						...
						<div class="container col-md-6">
							<fieldset>
								...
								<legend>Lựa chọn khác</legend>
									<!-- 								
									<input type="button" class="btn btn-primary" value="Thêm Nhà Cung Cấp mới (window.open)" onClick= 'window.open("{{ url("admin/supplier/addsupplier")}}", "_blank", "toolbar=no, scrollbars=yes, resizable=yes, top=100,left=200,width=600, height=500");' />	
									/new supplier portion -->								
									
							<!-- Button trigger modal -->
								<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
								  Đăng ký Nhà Cung Cấp mới (Boostrap Modal)
								</button>
								  ...
								  <div class="modal-dialog" role="document">
									<div class="modal-content">
									  <div class="modal-header">
										<h3 class="modal-title" id="exampleModalLabel">Thêm Nhà Cung Cấp mới</h3>
										<div id="addsupplier">
										<form class="form-horizontal" method="post" action="{!!url('admin/supplier/quickadd')!!}" enctype="multipart/form-data">	
											<input type="hidden" name="_token" value="{!! csrf_token() !!}">
											<fieldset>
												<legend></legend>
												...
												<div class="form-group">
												 ...
												 <select name="sel1" class="form-control">
													<option class="form-control">Nhà Cung Cấp tiềm năng</option>
													<option class="form-control">Nhà Cung Cấp từ đối thủ</option>
												...
												<div class="modal-footer">
													...
													<button type="submit" class="btn btn-success">Lưu Nhà Cung Cấp Mới</button>
												  </div>
											</fieldset>
										</form>
										</div>
